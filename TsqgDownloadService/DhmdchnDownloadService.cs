...
{
    public class DhmdchnDownloadService : PageFilesDownloadService
    {
        ...
        {
            return RegexHelper.GetLinks(pageContent).Where(link => Regex.IsMatch(link, filePattern)).Distinct();
        }
    }
}